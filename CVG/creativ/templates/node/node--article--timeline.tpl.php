...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="blog-item">
    ...
    <div class="blog-caption">
      <h3 class="post-title mb10"><?php print $title;?></h3>
      <div class="sub-post-title">
        <span><?php print date('d M, Y', $created);?></span>
      </div>
      <?php print render($content['body']);?>
      <div class="clearfix">
        <div class="pull-left"><a href="<?php print $node_url;?>" class="read-more">read more</a></div>
        <div class="pull-right">
          <i class="fa <?php if (isset( $node->field_type[$node->language])) print $node->field_type[$node->language][0]['value'];?> post-format">
          </i>
        </div>
      </div>
    </div>
