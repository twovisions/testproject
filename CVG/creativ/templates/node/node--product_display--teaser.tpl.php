...
<div id="node-<?php print $node->nid; ?>" class="product-item <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <?php print render($title_prefix); ?>
    <?php print render($title_suffix); ?>
    <?php $cart = $content['field_product_variations'];?>
  ...
  <div class="shop-desc">
    ...
    <!-- Open these comments if you want to show rating and wishlist in grid teaser
    <div class="rating">
